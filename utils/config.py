...
_C.DATA = CN()
_C.DATA.ROOT = 'E:\\TAD'
_C.DATA.TRAIN_FILE = './labels/TAD_train.txt'
_C.DATA.VAL_FILE = './labels/TAD_test.txt'
_C.DATA.DATASET = 'traffic'
_C.DATA.INPUT_SIZE = 224
_C.DATA.NUM_CLIPS = 16
_C.DATA.NUM_FRAMES = 5
_C.DATA.FRAME_INTERVAL = 6
_C.DATA.NUM_CLASSES = 400
_C.DATA.LABEL_LIST = './labels/traffic_2_labels.csv'
_C.DATA.FILENAME_TMPL = '{}.jpg'
# -----------------------------------------------------------------------------
# Model settings
# -----------------------------------------------------------------------------
_C.MODEL = CN()
...
# _C.MODEL.PRETRAINED = 'H:\\SDnormal_baseline\\ckpt_epoch_3.pth'
# _C.MODEL.PRETRAINED = './exp/SHT/ckpt_epoch_1.pth'
# _C.MODEL.PRETRAINED = 'H:\\exp\\SHT\\ckpt_epoch_20.pth'
...
def get_config(args):
    ...
    # Return a clone so that the defaults will not be altered, for the "local variable" use pattern
    config = _C.clone()
